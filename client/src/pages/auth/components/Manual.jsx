            ...
            <div className="px-20">
                <div>
                    ...
                    <p className="px-10">
                        ...
                        Nếu bạn chưa có tài khoản, hãy <a className="text-green-600" href="/register">Đăng ký</a> tại đây trước khi bắt đầu đăng tin mới. <br></br>
                        Nếu đã có tài khoản, sau khi <a className="text-green-600" href="/login">Đăng nhập</a> vào website, bạn bấm nút <a className="text-green-600" href="/dangtin">Đăng tin</a> để bắt đầu. <br></br>
                    ...
                    <ul className="list-disc list-inside px-10"><h3 className="font-bold">Lưu ý khi đăng tin</h3>
                        ...
                        <li>Sau khi nhập đầy đủ các thông tin, bấm ĐĂNG TIN NGAY và chờ vài giây để tin bạn hiển thị trên website, 
                            ...
                            các ô chọn màu bị sai, vui lòng nhập lại cho chính xác và bấm <a className="text-green-600" href="/dangtin">Đăng tin ngay</a> lại.
                        </li>
                    </ul>
                </div>
                <div>
                    ...
                    <p className="px-10">
                        Sau khi đăng nhập vào tài khoản của bạn, chọn <a className="text-green-600" href="/register">Tạo tài khoản cho người thuê trọ</a> và làm theo hướng dẫn.
                    </p>
                    <ul className="list-disc list-inside px-10"><h3 className="font-bold">Lưu ý</h3>
                        ...
                        <li>Sau khi nhập đầy đủ thông tin, bấm <a className="text-green-600" href="/register">Tạo tài khoản</a>.</li>
                    </ul>
                </div>
                <div>
                    <h2 className="font-bold">Hướng dẫn đăng nhập và xem thông tin điện nước hàng tháng (đối với người đã thuê trọ)</h2>
                    <p className="px-10">
                        Nếu bạn đã thuê được 1 phòng trọ được đăng trên website của chúng tôi, bạn sẽ được người thuê trọ của bạn cung cấp tài khoản và mật khẩu để đăng nhập vào hệ thống. Hãy chọn <a className="text-green-600" href="/login">Đăng nhập</a>. <br></br>
                        Nếu bạn chưa thuê được trọ, hãy vào <a className="text-green-600" href="/dashboard">Trang chủ</a> để tìm trọ.
                    </p>
                    <p className="px-10">
